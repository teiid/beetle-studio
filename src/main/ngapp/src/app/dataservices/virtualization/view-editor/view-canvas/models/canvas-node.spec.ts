...
describe("CanvasNode", () => {
  ...
  it("should create", () => {
    ...
    canvasNode = new CanvasNode("AddSourcesCommand1532362832377_-_connection=conn3/schema=public/table=stuff",
                                "SOURCE", "connection=conn3/schema=public/table=stuff", true);

    // Check the encoded id
    expect(canvasNode.id).toEqual("AddSourcesCommand1532362832377_-_connection6X6conn35X5schema6X6public5X5table6X6stuff");
  });
  ...
  it("should decodeId", () => {
    ...
    expect(decoded).toEqual("AddSourcesCommand1532362832377_-_connection=conn3/schema=public/table=stuff");
  });
